...
use App\Http\Controllers\HaciendaAnexoController;
...
Route::group(['prefix' => 'sale', 'as' => 'sale.'], function(){
        ...
        Route::get('savefactemp/{idsale}/{clientid}/{productid}/{cantida}/{price}/{nosujeto}/{exento}/{gravado}/{iva}/{renta}/{retenido}/{acuenta}/{fpago}/{fee}/{reserva}/{ruta}/{destino}/{linea}/{canal}/{description}/{tipoVenta}', [SaleController::class, 'savefactemp'])->name('savefactemp');
...
Route::group(['prefix' => 'report', 'as' => 'report.'], function(){
        ...
        Route::get('hacienda-anexos', [HaciendaAnexoController::class, 'index'])->name('hacienda-anexos');
        Route::post('hacienda-anexos/export', [HaciendaAnexoController::class, 'export'])->name('hacienda-anexos.export');
        Route::post('hacienda-anexos/export-excel', [HaciendaAnexoController::class, 'exportExcel'])->name('hacienda-anexos.export-excel');
    });
...
Route::middleware('auth')->group(function () {
    ...
    Route::group(['prefix' => 'airport', 'as' => 'airport.'], function(){
        Route::get('index', [App\Http\Controllers\AirportController::class, 'index'])->name('index');
        Route::post('store', [App\Http\Controllers\AirportController::class, 'store'])->name('store');
        Route::post('update', [App\Http\Controllers\AirportController::class, 'update'])->name('update');
        Route::get('getairportid/{id}', [App\Http\Controllers\AirportController::class, 'getairportid'])->name('getairportid');
        Route::get('destroy/{id}', [App\Http\Controllers\AirportController::class, 'destroy'])->name('destroy');
    });
