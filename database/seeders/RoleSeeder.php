...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        /**
         * permisos para modulo Anexos de Hacienda
         */
        Permission::create(['name' => 'report.hacienda-anexos']);
        Permission::create(['name' => 'report.hacienda-anexos.export']);
        Permission::create(['name' => 'report.hacienda-anexos.export-excel']);
