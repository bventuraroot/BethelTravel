                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="flights[${flightIndex}][destination_code]" class="form-control text-uppercase" placeholder="Ej. MDE" max="4" value="${originCode == 'SAL' && originCode != '' && destCode == '' ? 'MDE' : destCode}">
                            </div>
                            <div class="col-md-3">
