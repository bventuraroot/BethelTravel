        ...
        <tr valign="top">
            <td width=45%>
                <table width="100%">
                    <tr>
                        <td>
                            <img src="{{ logo_pdf($emisor[0]['ncr'] ?? ($emisor[0]['nrc'] ?? '')) }}" alt="logo" width="120px" style="display: block; margin: 0 auto; object-fit: contain;">
                        </td>
                    </tr>
                    <tr>
            ...
            <td>
                <table width="100%" style="border:1px solid #000;">
                    ...
                    <tr>
                        ...
                        <td>Normal</td>
                        <td><strong>Fecha emisión:</strong> {{ isset($json["fhRecibido"]) ? date('d/m/Y', strtotime($json["fhRecibido"])) : (isset($json["identificacion"]["fecEmi"]) ? date('d/m/Y', strtotime($json["identificacion"]["fecEmi"])) : (isset($documento[0]["fechacreacion"]) ? date('d/m/Y', strtotime($documento[0]["fechacreacion"])) : '')) }}</td>
                    </tr>
                    <tr>
                        <td><strong>Hora de emisión:</strong></td>
                        <td>{{ isset($json["fhRecibido"]) ? substr($json["fhRecibido"],12,8) : ($json["identificacion"]["horEmi"] ?? (isset($documento[0]["fechacreacion"]) ? substr($documento[0]["fechacreacion"],12,8) : '')) }}</td>
