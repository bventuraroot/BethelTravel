<?php
  ...
  return [
    ...
    "creatorUrl" => "·",
    "templateName" => "Bethel Travel SV",
    "templateSuffix" => "Sistema agencia de viaje",
    "templateVersion" => "5.0",
    "templateFree" => false,
    "templateDescription" => "Administracion",
    "templateKeyword" => "Para empresa de viaje Bethel Travel SV",
